...
async def test_digital_entity_created(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
    """InfoOnlyDigital should create a binary_sensor."""
    state = hass.states.get(DIGITAL_ENTITY_ID)
    assert state is not None


async def test_presence_entity_created(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
    """PresenceDetector should create a binary_sensor."""
    state = hass.states.get(PRESENCE_ENTITY_ID)
    assert state is not None


async def test_smoke_entity_created(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_digital_on_from_event(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_digital_off_from_event(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_digital_ignores_unrelated_events(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_presence_listens_to_active_uuid(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_smoke_listens_on_alarm_signals_off(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_smoke_ignores_action_uuid(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
