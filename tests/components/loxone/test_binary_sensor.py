...
async def test_digital_on_from_event(
    ...
    hass.bus.async_fire(EVENT, {DIGITAL_ACTIVE_UUID: 1.0})
...
async def test_digital_off_from_event(
    ...
    hass.bus.async_fire(EVENT, {DIGITAL_ACTIVE_UUID: 0.0})
    await hass.async_block_till_done()
...
async def test_presence_listens_to_active_uuid(
    ...
    hass.bus.async_fire(EVENT, {PRESENCE_ACTIVE_UUID: 1.0})
    await hass.async_block_till_done()
...
async def test_smoke_listens_on_alarm_signals_off(
    ...
    hass.bus.async_fire(EVENT, {SMOKE_ALARM_OFF_UUID: 1.0})
    await hass.async_block_till_done()
...
async def test_smoke_ignores_action_uuid(
    ...
    hass.bus.async_fire(EVENT, {SMOKE_ACTION_UUID: 1.0})
    await hass.async_block_till_done()
