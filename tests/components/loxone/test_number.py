...
async def test_number_state_from_event(
    hass: HomeAssistant, init_integration: MockConfigEntry
) -> None:
...
async def test_number_ignores_unrelated_event(
    hass: HomeAssistant, init_integration: MockConfigEntry
) -> None:
...
async def test_set_native_value_sends_command(
    hass: HomeAssistant, init_integration: MockConfigEntry
) -> None:
...
async def test_set_native_value_zero(
    hass: HomeAssistant, init_integration: MockConfigEntry
) -> None:
