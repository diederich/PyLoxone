...
async def test_alarm_entity_created(
...
async def test_alarm_state_disarmed(
    hass: HomeAssistant, init_integration: MockConfigEntry
) -> None:
...
async def test_alarm_state_armed_away(
    hass: HomeAssistant, init_integration: MockConfigEntry
) -> None:
...
async def test_alarm_state_armed_home(
    hass: HomeAssistant, init_integration: MockConfigEntry
) -> None:
...
async def test_alarm_state_arming_via_delay(
    hass: HomeAssistant, init_integration: MockConfigEntry
) -> None:
...
async def test_alarm_state_arming_via_armed_at(
    hass: HomeAssistant, init_integration: MockConfigEntry
) -> None:
...
async def test_triggered_takes_priority_over_armed(
    hass: HomeAssistant, init_integration: MockConfigEntry
) -> None:
...
async def test_alarm_arm_away_sends_command(
    hass: HomeAssistant, init_integration: MockConfigEntry
) -> None:
...
async def test_alarm_arm_home_sends_command(
    hass: HomeAssistant, init_integration: MockConfigEntry
) -> None:
...
async def test_alarm_disarm_sends_command(
    hass: HomeAssistant, init_integration: MockConfigEntry
) -> None:
...
async def test_alarm_extra_attributes(
    hass: HomeAssistant, init_integration: MockConfigEntry
) -> None:
