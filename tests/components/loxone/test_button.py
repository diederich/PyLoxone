...
async def test_button_extra_attributes(
    hass: HomeAssistant, init_integration: MockConfigEntry
) -> None:
...
async def test_press_sends_pulse(
    hass: HomeAssistant, init_integration: MockConfigEntry
) -> None:
...
async def test_button_event_updates_state(
    hass: HomeAssistant, init_integration: MockConfigEntry
) -> None:
...
async def test_button_ignores_unrelated_event(
    hass: HomeAssistant, init_integration: MockConfigEntry
) -> None:
