...
async def test_media_player_entity_created(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
    """AudioZoneV2 should create a media_player entity."""
    state = hass.states.get(MP_ENTITY_ID)
    assert state is not None


async def test_media_player_supported_features(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_media_player_device_class(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_volume_from_event(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_play_state_playing(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_play_state_paused(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_play_state_idle(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_media_play_sends_command(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_media_pause_sends_command(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_media_next_sends_command(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_media_previous_sends_command(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_set_volume_sends_command(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_volume_up_sends_command(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_volume_down_sends_command(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
