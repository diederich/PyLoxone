...
async def test_switch_entities_created(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_switch_attributes(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_switch_turns_on_from_event(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_switch_turns_off_from_event(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_switch_ignores_unrelated_events(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_switch_turn_on_sends_command(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_switch_turn_off_sends_command(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_switch_turn_on_noop_when_already_on(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_timed_switch_delay_attributes(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
...
async def test_timed_switch_delay_zero_means_off(hass: HomeAssistant, init_integration: MockConfigEntry) -> None:
